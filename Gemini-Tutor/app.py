...
<div class="main-header">
    <h1>🧠 Gemini Multimodal Tutor</h1>
    <p>Your AI-powered guide for exploring any topic</p>
</div>
...
def initialize_session_state():
    ...
    if "model_id" not in st.session_state:
        st.session_state.model_id = MODEL_OPTIONS["Gemini 2.0 Flash"]
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        selected_model_name = st.selectbox(
            ...
            index=list(MODEL_OPTIONS.values()).index(st.session_state.model_id),
