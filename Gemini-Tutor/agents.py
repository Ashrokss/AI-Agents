...
class TutorAppAgent:
    ...
    def __init__(
        self, model_id="gemini-2.0-flash", education_level="High School"
    ):
        """
        ...
        logger.info(
            f"TutorAppAgent initialized with {self.model_id} model and {education_level} education level"
        )
    ...
    def _create_agent(self):
        ...
        # Enable grounding for this model
        try:
    ...
    def create_learning_experience(self, search_topic, education_level=None):
        ...
        grounding_instructions = SEARCH_GROUNDING_INSTRUCTIONS
